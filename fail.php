                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2" id="product"><?php echo "Tu compra no puedo ser procesada exitosamente - ".$_GET['preference_id'] ?></span>
                                                </p>
                                    ...
                                    <div>
                                        <h3><?php echo "Referencia: ".$_GET['external_reference']." Pedido No: ".$_GET['collection_id'] ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
